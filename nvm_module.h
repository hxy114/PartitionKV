...
extern const size_t PM_META_NODE_SIZE;
extern const size_t PM_LOG_HEAD_SIZE;
extern const size_t PM_LOG_SIZE;
extern const size_t PERSIST_SIZE;//no use
extern const size_t PM_META_NODE_NUMBER;
extern const size_t PM_LOG_NUMBER;
...
extern const uint64_t PRE_SPLIT;//no use
extern const uint64_t SPLIT;

extern const uint64_t PRE_MERGE;//no use
extern const uint64_t MERGE;

extern const uint64_t K;//no use
extern const uint64_t PRE_SPLIT_NUMBER;//no use
extern const uint64_t PRE_MERGE_NUMBER;//no use
...
extern const double NEW_SPLIT;//no use
extern const double NEW_MERGE;//no use
...
typedef  struct PmLogHead{//size=128B
  ...
  uint64_t file_size;
  uint64_t used_size;
  uint16_t start_key_size;//no use
  char start_key[16];//no use
  uint16_t end_key_size;//no use
  char end_key[16];//no use
  uint64_t  next;
  char padding[56];//no use
}PmLogHead;
class NvmManager {
 public:
